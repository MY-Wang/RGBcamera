...
--               f:/GitHub/RGBcamera/Camera+HSV+led/Camera_Demo.srcs/sources_1/ip/Driver_SK6805_0/Driver_SK6805_0_sim_netlist.vhdl
...
architecture STRUCTURE of Driver_SK6805_0_Driver_SK6805 is
  ...
  signal \Send_Cnt[5]_i_5_n_0\ : STD_LOGIC;
  ...
  signal \Send_Cnt[8]_i_5_n_0\ : STD_LOGIC;
  signal \Send_Cnt[8]_i_6_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \Data_Cnt[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \Data_Cnt[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \Data_Cnt[5]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \Data_Cnt[6]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \Data_Cnt[7]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \Data_Cnt[8]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \Data_Cnt[8]_i_4\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of LED_IO_i_5 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of LED_IO_i_6 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \Send_Cnt[0]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \Send_Cnt[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \Send_Cnt[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \Send_Cnt[3]_i_1\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \Send_Cnt[5]_i_4\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \Send_Cnt[8]_i_4\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \Send_Cnt[9]_i_5\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \Send_Cnt[9]_i_6\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \Send_State[0]_i_10\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \Send_State[0]_i_5\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \Send_State[1]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \Send_State[1]_i_4\ : label is "soft_lutpair6";
begin
  LED_IO <= \^led_io\;
...
LED_IO_i_5: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\Send_Cnt[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFD"
    )
        port map (
...
\Send_Cnt[5]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\Send_Cnt[8]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"000EFEFE"
    )
        port map (
...
\Send_Cnt[8]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\Send_Cnt[8]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\Send_Cnt[8]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FEFF"
    )
        port map (
...
\Send_Cnt[9]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\Send_State[0]_i_10\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"A9"
    )
        port map (
...
\Send_State[0]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BBBE8882"
    )
        port map (
...
\Send_State[1]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00400000"
    )
        port map (
...
entity Driver_SK6805_0 is
  ...
  attribute X_CORE_INFO of Driver_SK6805_0 : entity is "Driver_SK6805,Vivado 2020.1";
end Driver_SK6805_0;
