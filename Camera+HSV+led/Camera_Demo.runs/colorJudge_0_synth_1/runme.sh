...
HD_PWD='F:/Vivado/pro_RGBcamera/Camera+HSV+led/Camera_Demo.runs/colorJudge_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log colorJudge_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source colorJudge_0.tcl
