...
HD_PWD='F:/Vivado/pro_RGBcamera/Camera+HSV+led/Camera_Demo.runs/RGB_To_HSV_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RGB_To_HSV_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RGB_To_HSV_0.tcl
