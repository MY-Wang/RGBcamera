...
#
# Generated by export_simulation on Wed Jul 29 15:46:33 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './colorJudge_0.sh' script.

./colorJudge_0.sh -reset_run
...
./colorJudge_0.sh -noclean_files

For more information on the script, please type './colorJudge_0.sh -help'.
