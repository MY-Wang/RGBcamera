...
#
# Generated by export_simulation on Wed Jul 29 15:46:49 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './RGB_To_HSV_0.sh' script.

./RGB_To_HSV_0.sh -reset_run
...
./RGB_To_HSV_0.sh -noclean_files

For more information on the script, please type './RGB_To_HSV_0.sh -help'.
