...
#
# Generated by Vivado on Mon Jul 27 16:27:41 +0800 2020
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="F:/Vivado/lab_demo/FPGA-Demo-Project/Image_Demo/Image_Demo.cache/compile_simlib/activehdl"
  fi
